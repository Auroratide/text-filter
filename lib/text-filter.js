export class TextFilter extends HTMLInputElement {
    ...
    get itemMatches() { return this.#itemMatches }
    set itemMatches(fn) {
        this.#itemMatches = fn
        this.doFilter()
    }
    ...
    disconnectedCallback() {
        // Do not disconnect entire target; there may be reasons to keep the items
        // filtered even after disconnection, so this should be handled by the
